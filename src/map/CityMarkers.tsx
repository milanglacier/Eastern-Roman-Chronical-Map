 ...
 * Re-renders whenever the camera bumps `viewVersion`. A city with a city
 * view can be clicked to enter it; inside a city view the map's markers
 * are hidden.
 */
