 ...
 * colour (= the fog colour), so the curved world melts into the sky. It
 * is the era's natural sky as a watercolour: soft gradient, painted clouds
 * with pooled edges, a gold-rimmed sun.
 */
